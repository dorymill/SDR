...
class WBFM(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.iio_pluto_source_0.set_frequency(107900000)
        self.iio_pluto_source_0.set_samplerate(3000000)
        self.iio_pluto_source_0.set_gain_mode(0, 'manual')
        self.iio_pluto_source_0.set_gain(0, 256)
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.qtgui_sink_x_0.set_frequency_range(107900000, self.samp_rate)
